...
export const vehicleClasses = [
  {
    ...
    detail:
      "Najczęstszy pierwszy wybór, bo każdą część można dokupić pojedynczo, a błąd konstrukcyjny naprawia się bez narzędzi. Elastyczność złączy trochę tłumi drgania na nierównościach, ale ta sama elastyczność oznacza, że rama pracuje pod obciążeniem inaczej niż sztywna konstrukcja — trzeba to uwzględnić przy doborze balastu.",
  },
  {
  ...
  },
  {
    ...
    summary: "Nadwozie zaprojektowane w darmowym programie i wydrukowane warstwa po warstwie.",
    advantage: "Dowolny kształt, jaki tylko wymyślisz — łącznie z takim, którego nie kupisz nigdzie gotowego.",
    drawback: "Przy niskiej temperaturze warstwy robią się kruche i pękają na krawędziach.",
    detail:
      "Jedyna klasa, w której kształt nadwozia realnie zmienia opór powietrza na dłuższej prostej — choć w skali garażowych prędkości różnica jest subtelna, a nie decydująca. Tor w piwnicy zimą bywa dla tej klasy ryzykowny, dopóki wydruk porządnie się nie zaaklimatyzuje.",
  },
  {
    slug: "rama-druciana",
    title: "Rama z giętego drutu",
    summary: "Zgięta ręcznie z aluminiowego drutu lub starych wieszaków, bez żadnego gotowego zestawu.",
    advantage: "Najlżejsza konstrukcja w całym zestawieniu — najszybszy rozpęd na starcie.",
    drawback: "Balans trzeba wyważyć ręcznie i dokładnie — źle rozłożony ciężar kładzie auto na pierwszym ostrym zakręcie.",
    detail:
      "Klasa dla cierpliwych — każdy egzemplarz jest odrobinę inny, bo drut nigdy nie zegnie się dwa razy identycznie. W zamian za tę nieprzewidywalność dostaje się najbardziej responsywne auto na starcie, zanim jeszcze pierwszy bieg zdąży się przegrzać.",
  },
  {
    slug: "przerobiona-zabawka",
    title: "Przerobiona stara zabawka",
    summary: "Gotowa skorupa z pchlego targu albo ze strychu, z podmienionym napędem od środka.",
